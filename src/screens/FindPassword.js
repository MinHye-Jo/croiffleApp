...
const FindPassword = (props) => {
  ...
  return (
    <ScrollView style={styles.topContainer}>
      ...
      <FindPwdModal modalOpen={findPwdModalOpen} navigation={props.navigation} onClose={() => setFindPwdModalOpen(false)} />
        ...
        <View style={{ marginTop: 20 }}>
          ...
          <View style={styles.row}>
            <TextInput style={{ ...styles.greyInput, flex: 1.5, marginTop: 10 }}
              placeholder="인증번호를 입력해주세요" placeholderTextColor='rgb(174, 174, 174)'
